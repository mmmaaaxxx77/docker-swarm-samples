...
if __name__ == "__main__":
    ...
    fun = fun.select(
        ...
        'IP',
        'realname',
        api_format_udf('API_METHOD').alias('API_METHOD'),
        'count').sort('start', 'USERNAME')
    fun = fun.select(
        date_format('start', "YYYY-MM-dd HH:mm").alias('start'),
        date_format('end', "YYYY-MM-dd HH:mm").alias('end'),
        'USERNAME',
        'IP',
        'realname',
        'API_METHOD',
